const dadesEnllacos = [
  {
    ...
    enllacos: [
      ...
      { 
        ...
        descripcio: "Validació de comptes IBAN i codis bancaris BIC/SWIFT." 
      },
      { 
        titol: "VIES Validator (European Comission)", 
        url: "https://ec.europa.eu/taxation_customs/vies/#/vat-validation", 
        descripcio: "Validació de CIF d'empreses intracomunitàries al sistema VIES." 
      },
      { 
        titol: "Letra NIF", 
        url: "https://www.letranif.com/", 
        descripcio: "Validació de números i lletres de NIF/DNI/NIE/CIF." 
      },
      { 
        titol: "Empresia", 
        url: "https://www.empresia.es/", 
        descripcio: "Obtenció de dades fiscals i mercantils d'empreses." 
      },
      { 
